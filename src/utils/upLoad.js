export const triggerFileUpload = (param) => {
  ...
  function createNotification (name, size) {
    // 检查容器是否已经存在
    let container = document.querySelector('.zh1-notification-container')
  ...
  function updateNotification (notification, progress, status) {
    notification.querySelector('.zh1-progress').innerText = `${progress}%`
    notification.querySelector('.zh1-status').innerText = status
  }
